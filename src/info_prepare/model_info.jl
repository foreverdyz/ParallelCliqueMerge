...
function model_info(filename::String)
    ...
    #then we transfer the default sparse data structure of constraints to list structure
    #(sparse data structure in julia is time-consuming when accessing contents)
