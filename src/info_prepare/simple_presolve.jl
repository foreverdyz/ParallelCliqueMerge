...
function simple_presolve(A::AbstractSparseArray, con_set::Vector{Vector{Int64}}, con_coef::AbstractVector, con_ub::AbstractVector, con_lb::AbstractVector, var_ub::AbstractVector, var_lb::AbstractVector, var_type::AbstractVector)
    I, var_ub, var_lb, var_type = singleton_remove(con_set, con_coef, con_ub, con_lb, var_ub, var_lb, var_type)
    #return A[I, :], con_set[I], con_coef[I], con_ub[I], con_lb[I], var_ub, var_lb, var_type
    con_ub, con_lb, var_ub, var_lb = bounds_strengthen(con_set, con_coef, con_ub, con_lb, var_ub, var_lb, I, var_type)
    A = A[I, :]
    con_set = con_set[I]
    con_coef = con_coef[I]
    ...
    #var_type, org_to_bin, bin_to_org = iden_bin_list(var_type)
    #return A, con_set, con_coef, con_ub, con_lb, var_ub, var_lb, var_type, org_to_bin, bin_to_org, var_type
end
...
"""
function singleton_remove(con_set::Vector{Vector{Int64}}, con_coef::AbstractVector, con_ub::AbstractVector, con_lb::AbstractVector, var_ub::AbstractVector, var_lb::AbstractVector, var_type::AbstractVector)
    #get m constraints
    m = length(con_set)
...
"""
function bounds_strengthen(con_set::Vector{Vector{Int64}}, con_coef::AbstractVector, con_ub::AbstractVector, con_lb::AbstractVector, var_ub::AbstractVector, var_lb::AbstractVector, I::Vector{Int64}, var_type::AbstractVector)
    for j in I
        """
